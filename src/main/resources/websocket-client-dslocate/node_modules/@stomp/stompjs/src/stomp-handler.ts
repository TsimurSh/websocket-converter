import { BYTE } from '@stomp/stompjs/src/byte';
import { Client } from '@stomp/stompjs/src/client';
import { FrameImpl } from '@stomp/stompjs/src/frame-impl';
import { IMessage } from '@stomp/stompjs/src/i-message';
import { ITransaction } from '@stomp/stompjs/src/i-transaction';
import { Parser } from '@stomp/stompjs/src/parser';
...
import {
  ...
  StompSocketState,
  wsErrorCallbackType,
} from '@stomp/stompjs/src/types';
import { Versions } from '@stomp/stompjs/src/versions';
import { augmentWebsocket } from '@stomp/stompjs/src/augment-websocket';
